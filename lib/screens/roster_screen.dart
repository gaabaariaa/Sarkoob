    ...
    return Scaffold(
      ...
      body: _loading ? Center(child: CircularProgressIndicator()) : Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          SizedBox(height: 12),
          Row(children: [Expanded(child: TextField(controller: _nameController, style: TextStyle(color: Colors.white), decoration: InputDecoration(labelText: 'اسمِ بازیکنِ جدید', border: OutlineInputBorder()), onSubmitted: (_) => _addPlayer())), SizedBox(width: 8), ElevatedButton(onPressed: _addPlayer, child: Text('افزودن'.tr))]),
          SizedBox(height: 12),
