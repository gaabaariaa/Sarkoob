...
class _GenericTeamCard extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => LayoutBuilder(builder: (context, constraints) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.surfaceCard, borderRadius: BorderRadius.circular(24), border: Border.all(color: team.color, width: 1.7), boxShadow: [BoxShadow(color: Colors.black.withAlpha(64), blurRadius: 20, offset: const Offset(0, 10))]),
