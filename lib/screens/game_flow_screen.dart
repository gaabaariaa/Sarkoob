...
class _GameFlowScreenState extends State<GameFlowScreen> {
            ...
            return ListView(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  title: Text('فقط بازیکنانِ زنده', style: TextStyle(color: Colors.white, fontSize: 14)),
                  value: showOnlyAlive,
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('با نگه‌داشتن و کشیدن جابه‌جا کن.',
                ...
                children: [
                  ...
                  if (selectedTarget != null) ...[
                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton(
                            ...
                            child: Text('تنبیه', style: TextStyle(fontSize: 12)),
                          ),
                        ),
                        SizedBox(width: 6),
                        Expanded(
                          child: OutlinedButton(
                            ...
                            child: Text('گرفتنِ حقِ رأی', style: TextStyle(fontSize: 12)),
                          ),
                        ),
                        SizedBox(width: 6),
                        Expanded(
                          child: OutlinedButton(
                            ...
                            child: Text('اخراجِ مستقیم', style: TextStyle(fontSize: 12)),
                          ),
                        ),
                      ],
                    ),
                    ...
                    TextField(
                      ...
                      style: TextStyle(color: Colors.white),
                      decoration: InputDecoration(hintText: 'دلیل (مثلاً حرفِ خارج از نوبت، تقلب)'),
                    ),
                  ],
                ],
              ),
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: [
                    ...
                    DropdownMenuItem(value: 'unknown', child: Text('نامشخص')),
                  ],
    ...
    if (subject == null) {
      return Center(child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(height: 6),
          Text('رأی همه‌ی بازیکنان ثبت شده؛ نتیجه را محاسبه کن.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white60, fontSize: 13)),
          SizedBox(height: 20),
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (isRunoff) ...[
                SizedBox(height: 5),
                Text('فقط بین نامزدهای مساوی دوباره رأی می‌گیریم.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white54, fontSize: 11)),
              ],
              SizedBox(height: 14),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 14, vertical: 12),
        ...
        Expanded(
          child: candidates.isEmpty
              ? Center(child: Text('نامزدی برای انتخاب وجود ندارد.', style: TextStyle(color: Colors.white38)))
              : GridView.builder(
                  padding: EdgeInsets.only(bottom: 4),
      ...
      return Center(
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            SizedBox(height: 7),
            Text('دفاع همه‌ی افراد ثبت شد. حالا وارد رأی‌گیری نهایی شو.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white60, fontSize: 12, height: 1.5)),
            SizedBox(height: 18),
  ...
  Widget _scoreDetailButton(BuildContext ctx, List<SessionPlayer> players) {
    return OutlinedButton.icon(
      ...
      label: Text('جزئیاتِ امتیازِ همه‌ی بازیکنان'),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 5),
              Text('یکی از چهار رمز را برای این بمب انتخاب کن.', style: TextStyle(color: AppTheme.uiMutedText, fontSize: 12)),
              SizedBox(height: 16),
      ...
      return ModernNightPanel(
        ...
        body: Column(
          children: [
            ...
            SizedBox(height: 10),
            Text('حالا بگو همه چشماشون رو باز کنن.',
      ...
      child: Column(
        children: [
          ModernNightPanel(
            ...
            body: Text('همه‌ی بازیکن‌ها چشماشون رو ببندن؛ یک تصمیم مخفیانه در جریانه.',
    ...
    return ModernNightPanel(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 14),
          Text('محافظ را بی‌سروصدا بیدار کن و بپرس: می‌خواهی برای نجات هدف فدا شوی؟',
            textAlign: TextAlign.center, style: TextStyle(color: AppTheme.uiMutedText, fontSize: 12, height: 1.5)),
        ],
      ),
    ...
    return Column(
      children: [
        ...
        if (controller.canIndependentLeaderActTonight)
          ...
          Text('امشب دیگه اقدامی ممکن نیست.', style: TextStyle(color: Colors.white38)),
      ],
    );
  }
            ...
            return SafeArea(
              child: Padding(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text('ترور: هدف + حدسِ نقش', style: TextStyle(color: AppTheme.uiPrimaryLight)),
                    SizedBox(height: 12),
                    DropdownButton<SessionPlayer>(
                      hint: Text('انتخاب هدف', style: TextStyle(color: Colors.white70)),
                      dropdownColor: AppTheme.uiSurface,
                      value: selectedTarget,
                      items: targets
                    ...
                    DropdownButton<String>(
                      hint: Text('حدسِ نقش', style: TextStyle(color: Colors.white70)),
                      dropdownColor: AppTheme.uiSurface,
    ...
    return Column(
      children: [
        if (controller.slaughterResultMessage != null)
          ...
          Text('تصمیمِ امشب ثبت شد.', style: TextStyle(color: Colors.white70)),
      ],
    );
  }
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 12),
            Expanded(child: Text('کلمه‌ی حکم اعدام')),
          ],
        ),
        content: TextField(
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (dialogContext, setDialogState) => AlertDialog(
          ...
          title: Row(children: [
            ...
            SizedBox(width: 12), Text('بازجویی'),
          ]),
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            Text('هدف و سؤال اختیاری را برای ثبت این بازجویی انتخاب کن.',
                style: TextStyle(color: AppTheme.uiMutedText, fontSize: 12)),
            SizedBox(height: 14),
            DropdownButtonFormField<SessionPlayer>(
              isExpanded: true, value: selectedTarget, dropdownColor: AppTheme.uiCard,
              decoration: InputDecoration(labelText: 'هدف بازجویی', prefixIcon: Icon(Icons.person_search_rounded),
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(16))),
    ...
    return Column(
      children: [
        ...
        OutlinedButton.icon(
          ...
          label: Text('پرسیدنِ سؤالِ اطلاعاتی'),
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (dialogContext, setDialogState) => AlertDialog(
          ...
          title: Row(children: [
            ...
            SizedBox(width: 12), Expanded(child: Text('سؤال اطلاعاتی')),
          ]),
          content: SizedBox(width: double.maxFinite,
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Text('بازیکن‌های مورد سؤال را انتخاب کن.',
                style: TextStyle(color: AppTheme.uiMutedText, fontSize: 12)),
              SizedBox(height: 10),
    ...
    return Column(
      children: [
        ...
        OutlinedButton.icon(
          ...
          label: Text('دادنِ اسلحه به یه بازیکن'),
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (dialogContext, setDialogState) => AlertDialog(
          ...
          title: Row(children: [
            ...
            SizedBox(width: 12), Text('دادنِ اسلحه'),
          ]),
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            DropdownButtonFormField<SessionPlayer>(
              isExpanded: true, value: selectedTarget, dropdownColor: AppTheme.uiCard,
              decoration: InputDecoration(labelText: 'بازیکن دریافت‌کننده', prefixIcon: Icon(Icons.person_rounded),
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(16))),
              items: targets.map((p) => DropdownMenuItem(value: p, child: Text(p.name))).toList(),
              onChanged: (v) => setDialogState(() => selectedTarget = v),
            ),
            ...
            RadioListTile<GunType>(
              ...
              title: Text('مشقی', style: TextStyle(color: Colors.white)),
              subtitle: Text('برای تمرین؛ شلیک واقعی ندارد.', style: TextStyle(color: AppTheme.uiMutedText, fontSize: 11)),
            ),
            RadioListTile<GunType>(
              ...
              subtitle: Text('گلوله واقعی و قابل شلیک.', style: TextStyle(color: AppTheme.uiMutedText, fontSize: 11)),
            ),
          ]),
          actions: [
            TextButton(onPressed: () => Navigator.of(dialogContext).pop(), child: Text('انصراف')),
    ...
    return Column(
      children: [
        ...
        OutlinedButton.icon(
          ...
          label: Text('نجاتِ یه بازیکنِ دیگه'),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 3),
                          Text('هدف و حدسِ نقش را مشخص کن', style: TextStyle(color: AppTheme.uiMutedText, fontSize: 12)),
                        ],
                      ),
                    ),
                  ],
      ...
      children: [
        ...
        if (halfAlive.isEmpty)
          ...
          OutlinedButton.icon(
            ...
            label: Text('برگردوندنِ یه بازیکنِ نیمه‌جان'),
            ...
            return SafeArea(
              child: Padding(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text('سلاخی: هدف + حدسِ نقش', style: TextStyle(color: AppTheme.uiPrimaryLight)),
                    SizedBox(height: 12),
                    DropdownButton<SessionPlayer>(
                      hint: Text('انتخاب هدف', style: TextStyle(color: Colors.white70)),
                      dropdownColor: AppTheme.uiSurface,
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('هنوز بازیکنی برای نمایش نیست.', style: TextStyle(color: AppTheme.uiMutedText)),
                ],
              ),
            )
          else
