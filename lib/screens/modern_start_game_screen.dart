                  ...
                  child: ConstrainedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Text(
                          'رنگ و هویت تیم‌ها و نقش‌ها در مرحله‌ی بعدی بدون تغییر باقی می‌ماند.',
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          gradient: RadialGradient(
            ...
            radius: 1.2,
            colors: [AppColors.gold.withOpacity(0.10), AppColors.background],
            stops: const [0, 0.7],
          ),
        ),
      ),
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text('شروع بازی', style: AppTheme.headingFont(size: 26)),
              Text(
                'میز بازی را آماده کن',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.black.withOpacity(0.30), blurRadius: 24, offset: const Offset(0, 12)),
        ],
      ),
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: AppColors.gold.withOpacity(0.16), blurRadius: 22)],
            ),
            child: const Icon(Icons.groups_rounded, color: Color(0xFF251A04), size: 31),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('بازیکن‌های این میز', style: AppTheme.headingFont(size: 22)),
                const SizedBox(height: 3),
                Text(
                  total == 0 ? 'بازیکن‌ها را اضافه کن تا میز آماده شود.' : '$total نفر برای بازی ثبت شده‌اند.',
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.mutedText),
                ),
              ],
            ),
          ...
          children: [
            ...
            Align(
              ...
              child: TextButton.icon(
                ...
                label: const Text('بازیکنان ذخیره‌شده / تنظیمات کامل'),
              ),
            ),
          ],
        ),
...
class _EmptyPlayers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Icon(Icons.person_outline_rounded, size: 34, color: AppColors.subtleText),
          const SizedBox(height: 8),
          Text('هنوز بازیکنی اضافه نشده', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white)),
          const SizedBox(height: 3),
          Text('از کادر بالا شروع کن.', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.subtleText)),
        ],
      ),
    );
  }
              ...
              (entry) => Container(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                    ...
                    child: Text('${entry.key + 1}', style: const TextStyle(color: AppColors.goldLight, fontWeight: FontWeight.w800)),
                  ),
                  title: Text(entry.value, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                  trailing: IconButton(
...
class _StatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: (ready ? AppColors.gold : AppColors.bloodRedLight).withOpacity(0.08),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: (ready ? AppColors.gold : AppColors.bloodRedLight).withOpacity(0.20)),
      ),
      child: Row(
        children: [
          Icon(ready ? Icons.check_circle_rounded : Icons.info_outline_rounded, color: ready ? AppColors.gold : AppColors.bloodRedLight),
          const SizedBox(width: 10),
          Expanded(child: Text(text, style: const TextStyle(color: Colors.white70, fontWeight: FontWeight.w700))),
          if (ready) const Icon(Icons.arrow_back_rounded, color: AppColors.gold, size: 19),
        ],
      ),
    );
  }
