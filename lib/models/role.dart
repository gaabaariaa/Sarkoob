...
class SarkoobRoles {
  ...
  static final ocean = GameRole(
    ...
    description:
        ...
        '(شاملِ جاسوس، که هیچ حالتِ مخفیِ ویژه‌ای نداره) یا زودیاک باشه، '
        'خودِ اوشن همون‌لحظه حذف می‌شه.',
    canRecruitResistance: true,
  );

  /// برخلافِ پرستویِ نظام، هیچ مکانیزمِ مخفی‌کاری نداره — کاملاً علنیه
  /// از شبِ اول (اصلاحِ کاربر؛ قبلاً به‌اشتباه معادلِ کاملِ پرستویِ نظام
  /// پیاده‌سازی شده بود).
  static final spy = GameRole(
    ...
    teamId: SarkoobTeams.mafiaGang.id,
    description:
        'از شبِ اول، کاملاً علنی و بدونِ هیچ تفاوتی، عضوِ تیمِ مافیاست: از '
        'همون شبِ اول با بقیه‌ی مافیا بیدار می‌شه، و استعلامِ کارآگاه روش '
        'از همون شبِ اول لایک (مثبت) نشون می‌ده — دقیقاً مثلِ یه عضوِ '
        'عادیِ مافیا.',
  );
