...
class SarkoobRoles {
  ...
  static final bomber = GameRole(
    ...
    description:
        ...
        'شد؛ رمزِ غلط یعنی بمب ترکید و هدف حذف می‌شه (با رعایتِ نیمه‌جانِ '
        'کنستانتین، مثلِ هر حذفِ عادی).',
    canPlantBomb: true,
  );
  ...
  static final guard = GameRole(
    ...
    description:
        ...
        'هدف رمز رو حدس بزنه، با حدسِ درست هدف نجات پیدا می‌کنه ولی با '
        'حدسِ غلط، هم هدف هم خودِ محافظ (چون نقشش افشا شده) کاملاً از بازی '
        'خارج می‌شن. جدا از اون، یه پدافندِ غیرفعال هم داره: اگه شبی '
        'زودیاک با شاتِ عملیاتِ سری هدفش بگیره، به‌جای اینکه خودش صدمه '
        'ببینه، زودیاک همون‌لحظه کاملاً از بازی خارج می‌شه.',
